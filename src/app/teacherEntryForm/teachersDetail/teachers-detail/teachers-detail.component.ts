...
export class TeachersDetailComponent implements OnInit {
  ...
  udise_code = {'udiseSchCode':'20241205604'};
  teacherList:any;
  teacherListTest:any;

  constructor(private outSideService:OutsideServicesService, private setDataService:DataService, private router:Router) { }
  ...
  onViewClick(value){
    ...
    this.setDataService.setData(this.teacherList[value])
    // this.teacherListTest = this.teacherList[value]
    sessionStorage.setItem('singleTeacherList',this.teacherList[value])
